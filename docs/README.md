# AUREUM DIGITAL - Документация проекта

## 📋 Описание

AUREUM DIGITAL - премиальный веб-сайт международного агентства цифрового маркетинга и стратегии бренда. Проект представляет собой современное одностраничное приложение (SPA) с блогом и системой роутинга.
